        ...
        for jtof1 in range(len(tof1_days)):
            ...
            for rp in rp_grid:
                ...
                for theta in theta_grid:
                    # Rotate vinf_in around its direction by theta in B-plane
                    # Simple rotation: rotate perpendicular component
                    ...
                    # Rotate vinf_in by delta around axis perpendicular to vinf_in
                    # using theta to choose rotation axis
